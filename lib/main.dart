...
class NotificationController {
  ...
  ************************************************ */
  static Future<void> createNotificationFromJson() async {
      ...
      body: Center(
        child: Column(
          ...
          children: const <Widget>[
            Text(
              'Push the buttons above to create new notifications',
            ),
          ],
        ),
      ),
          ...
          children: [
            Wrap(
              ...
              children: [
                ...
                FloatingActionButton(
                  heroTag: '5',
                  onPressed: () => NotificationController.createNotificationFromJson(),
                  tooltip: 'From Json',
                  child: const Icon(Icons.javascript_sharp),
                ), const SizedBox(width: 10),
                FloatingActionButton(
                  heroTag: '6',
                  onPressed: () => NotificationController.showNotificationWithSilentActionButtons(30),
                  tooltip: 'Silent Notification',
                  child: const Icon(Icons.do_not_disturb_on_total_silence),
                ),const SizedBox(width: 10),
                FloatingActionButton(
                  heroTag: '7',
                  onPressed: () => NotificationController.showBasicNotification(30),
                  tooltip: 'Basic Notification',
                  child: const Icon(Icons.notification_add),
                ),const SizedBox(width: 10),
                FloatingActionButton(
                  heroTag: '7',
                  onPressed: () => NotificationController.showEmojiNotification(40),
                  tooltip: 'Emoji Notification',
                  child: const Icon(Icons.emoji_emotions),
                ),const SizedBox(width: 10),
                FloatingActionButton(
                  heroTag: '8',
                  onPressed: () => NotificationController.showCallNotification(40,5),
                  tooltip: 'Call Notification',
